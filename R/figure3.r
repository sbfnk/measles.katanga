...
figure3 <- function()
{
    cases_annual <- katanga_measles_cases %>%
        ...
        spread(year, cases) %>%
        mutate(`201013`=`2010`+`2011`+`2012`+`2013`) %>%
        ...
        mutate(size=if_else(`201013`>0.015, "previous_big", "smallish"),
    ...
    p <- ggplot(cases_annual, aes(x=`201013`*1000, y=`2015`*1000,
        ...
        scale_x_continuous("Incidence in 2010-13 (per 1000)") +
